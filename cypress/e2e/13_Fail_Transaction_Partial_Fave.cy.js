...
describe('Fail Transaction using partial Credit points and Fave', () => {
    let order_id;
    ...
    const apiUrl = 'https://app-dev.iimmpact.com/v1/users/current';

    it('Should fail Transaction with Partial Fave and credit points', () => {
